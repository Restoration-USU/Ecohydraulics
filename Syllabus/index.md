...
This course will typically be taught every other Spring. The first revamped version of the class was taught in [Spring 2020]({{ site.baseurl }}/syllabus/2021_Spring.html) and next class is scheduled to be taught Spring 2022. Wheaton has a sabbatical planned for Fall 2022-2023. The course is planned to be taught again  in Spring 2024.
...
<!--- THESE ARE FROM FLUVIAL... BUSTER AND JOE TO UPDATE
# Course Objectives
